    ...
    * */
    private void testHumans(){
        ...
        for(int i=0; i<humans.length; i++){
            System.out.println("Name : "+humans[i].getName()+" ,\tAge : "+humans[i].getAge()+" ,\tWeight : "+humans[i].getWeight());
        }
        ...
        for(int i=0; i<sortedArray.length; i++){
            System.out.println("Name : "+((Human)sortedArray[i]).getName()+" ,\tAge : "+((Human)sortedArray[i]).getAge()+" ,\tWeight : "+((Human)sortedArray[i]).getWeight());
        }
    ...
    * */
    private void testCars(){
        ...
        for(int i=0; i<cars.length; i++){
            System.out.println("Concern : "+cars[i].getConcern()+" ,\tColor : "+cars[i].getColor()+" ,\tMax speed : "+cars[i].getMaxSpeed()+" ,\tPassengers :\t"+cars[i].getPassengers());
        }
        ...
        for(int i=0; i<sortedArray.length; i++){
            System.out.println("Concern : "+((Car)sortedArray[i]).getConcern()+" ,\tColor : "+((Car)sortedArray[i]).getColor()+" ,\tMax speed : "+((Car)sortedArray[i]).getMaxSpeed()+" ,\tPassengers :\t"+((Car)sortedArray[i]).getPassengers());
        }
    }
}
